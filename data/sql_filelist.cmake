...
# When setting PROJ_DB_FAST_BUILD, we defer the insertion of check triggers
# until the very end to save build time. We also entirerly skip running
# final_consistency_checks.sql.
# Typical build time with PROJ_DB_FAST_BUILD=OFF: 60 seconds
# Typical build time with PROJ_DB_FAST_BUILD=ON: 3.7 seconds

set(SQL_FILES
  "${SQL_DIR}/begin.sql"
  "${SQL_DIR}/proj_db_table_defs.sql"
)
if (NOT PROJ_DB_FAST_BUILD)
