...
INSERT INTO "concatenated_operation" VALUES('EPSG','7811','NTF (Paris) to ETRS89-FRA [RGF93 v1] (2)','Second step is an emulation (using the NTv2 method) of the geocentric interpolation method described in CT code 9337. Note that the grid file parameters are of opposite sign.','EPSG','4807','EPSG','4171',1.0,'IOGP-Fra NTv2',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','8633','Yoff to WGS 84 (1)','Derived via WGS72. Can be used as a single position vector transformation with parameter values of dX = -37 m, dY = +157 m, dZ = +89.5 m, rX = rY = 0 sec, rZ = 0.554 sec, dS = 0.219 ppm','EPSG','4310','EPSG','4326',26.0,'EPSG-SEN',0);
INSERT INTO "usage" VALUES('EPSG','10725','concatenated_operation','EPSG','8633','EPSG','1207','EPSG','1160');
INSERT INTO "concatenated_operation" VALUES('EPSG','8634','Beduaram to WGS 84 (1)','Derived via WGS72BE. Can be used as a single position vector transformation with parameter values of dX = -101 m, dY = -111 m, dZ = +188.9 m, rX = rY = 0 sec, rZ = 0.814 sec, dS = -0.38 ppm','EPSG','4213','EPSG','4326',16.0,'ELF-Ner SE',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','8655','Manoca 1962 to WGS 84 (2)','Derived via WGS 72BE. Can be implemented as a single position vector transformation with parameter values of dX = -56.7 m, dY = -171.8 m, dZ = -38.7 m, rX = rY = 0 sec, rZ = 0.814 sec, dS = -0.38 ppm.','EPSG','4193','EPSG','4326',6.0,'OGP-Cmr',0);
INSERT INTO "usage" VALUES('EPSG','10747','concatenated_operation','EPSG','8655','EPSG','2555','EPSG','1136');
INSERT INTO "concatenated_operation" VALUES('EPSG','8656','Mhast (offshore) to WGS 84 (1)','Derived via WGS 72BE. Can be implemented as a single position vector transformation with parameter values of dX = -255.0 m, dY = -29.0 m, dZ = -103.1 m, rX = rY = 0 sec, rZ = 0.814 sec, dS = -0.38 ppm.','EPSG','4705','EPSG','4326',11.0,'OGP-Ago Cab',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','10393','Cascais height to ZH Portugal depth (2)','The Zero Hidrografico surface is defined to be 2.08 metres below the Cascais vertical reference surface in the Tagus estuary off Lisbon and 2.0m below the Cascais vertical reference surface offshore mainland Portugal (see CT 10392).','EPSG','5780','EPSG','10349',0.0,'IH-Por Tagus',0);
INSERT INTO "usage" VALUES('EPSG','20320','concatenated_operation','EPSG','10393','EPSG','4692','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10394','Cais da Pontinha height to ZH Portugal depth (1)','Offshore of Madeira, Desertas and Selvagens islands the Zero Hidrografico (CD Portugal) surface is defined to be 1.4m below the Cais da Pontinha vertical reference surface.','EPSG','6178','EPSG','10349',0.0,'IH-Por Madeira',0);
INSERT INTO "usage" VALUES('EPSG','20071','concatenated_operation','EPSG','10394','EPSG','4695','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10395','Cais da Vila height to ZH Portugal depth (1)','Offshore of Porto Santo island the Zero Hidrografico (CD Portugal) surface is defined to be 1.4m below the Cais da Vila vertical reference surface.','EPSG','6179','EPSG','10349',0.0,'IH-Por Porto Santo',0);
INSERT INTO "usage" VALUES('EPSG','20105','concatenated_operation','EPSG','10395','EPSG','4696','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10396','Santa Cruz das Flores height to ZH Portugal depth (1)','Offshore of Flores and Corvo islands the Zero Hidrografico (CD Portugal) surface is defined to be 1.0m below the Santa Cruz das Flores vertical reference surface.','EPSG','6185','EPSG','10349',0.0,'IH-Por Flores',0);
INSERT INTO "usage" VALUES('EPSG','20073','concatenated_operation','EPSG','10396','EPSG','4697','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10397','Horta height to ZH Portugal depth (1)','Offshore of Faial island the Zero Hidrografico (CD Portugal) surface is defined to be 1.0m below the Horta vertical reference surface.','EPSG','6181','EPSG','10349',0.0,'IH-Por Faial',0);
INSERT INTO "usage" VALUES('EPSG','20321','concatenated_operation','EPSG','10397','EPSG','4698','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10398','Cais da Madalena height to ZH Portugal depth (1)','Offshore of Pico island the Zero Hidrografico (CD Portugal) surface is defined to be 1.0m below the Cais da Madalena vertical reference surface.','EPSG','6182','EPSG','10349',0.0,'IH-Por Pico',0);
INSERT INTO "usage" VALUES('EPSG','20322','concatenated_operation','EPSG','10398','EPSG','4699','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10399','Cais das Velas height to ZH Portugal depth (1)','Offshore of S. Jorge island the Zero Hidrografico (CD Portugal) surface is defined to be 1.0m below the Cais das Velas vertical reference surface.','EPSG','6180','EPSG','10349',0.0,'IH-Por S Jorge',0);
INSERT INTO "usage" VALUES('EPSG','20081','concatenated_operation','EPSG','10399','EPSG','4700','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10400','Santa Cruz da Graciosa height to ZH Portugal depth (1)','Offshore of Graciosa island the Zero Hidrografico (CD Portugal) surface is defined to be 1.0m below the Santa Cruz da Graciosa vertical reference surface.','EPSG','6183','EPSG','10349',0.0,'IH-Por Graciosa',0);
INSERT INTO "usage" VALUES('EPSG','20106','concatenated_operation','EPSG','10400','EPSG','4734','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10409','Cais da Figueirinha height to ZH Portugal depth (1)','Offshore of Terceira island the Zero Hidrografico (CD Portugal) surface is defined to be 1.0m below the Cais da Figueirinha vertical reference surface.','EPSG','6184','EPSG','10349',0.0,'IH-Por Terceira',0);
INSERT INTO "usage" VALUES('EPSG','20077','concatenated_operation','EPSG','10409','EPSG','4735','EPSG','1198');
INSERT INTO "concatenated_operation" VALUES('EPSG','10410','Ponta Delgada height to ZH Portugal depth (1)','Offshore of S. Miguel island the Zero Hidrografico (CD Portugal) surface is defined to be 1.0m below the Ponta Delgada vertical reference surface.','EPSG','6187','EPSG','10349',0.0,'IH-Por S Miguel',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','10675','BES2020 Saba to Saba height (1)','This operation is not reversible because step 2 is not reversible. For a reversible alternative see BES2020 Saba to Saba + Saba height (1) (code 10755).','EPSG','10638','EPSG','10642',0.25,'NSGI-Bes Saba 2020',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','10755','BES2020 Saba to Saba + Saba height (1)','Reversible alternative to BES2020 Saba to Saba height (1) (code 10675).','EPSG','10638','EPSG','10643',0.25,'NSGI-Bes Saba 2020',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','10818','ITRF2014 to ETRS89-LTU [LKS94] (1)','The coordinate epoch (in years) of the coordinates referenced to the source CRS (ITRF2014) is user-defined and is used as the source epoch in step 2.','EPSG','7789','EPSG','4950',0.013,'NKG2020',0);
INSERT INTO "usage" VALUES('EPSG','24001','concatenated_operation','EPSG','10818','EPSG','1145','EPSG','1027');
INSERT INTO "concatenated_operation" VALUES('EPSG','10824','ITRF2014 to ETRS89-SWE [SWEREF 99] (1)','The coordinate epoch (in years) of the coordinates referenced to the source CRS (ITRF2014) is user-defined and is used as the source epoch in step 2. For coordinates originating before 2021-02-07, the NKG2008 transformation should be used.','EPSG','7789','EPSG','4976',0.004,'NKG2020',0);
INSERT INTO "usage" VALUES('EPSG','24002','concatenated_operation','EPSG','10824','EPSG','1225','EPSG','1027');
INSERT INTO "concatenated_operation" VALUES('EPSG','10825','ITRF2014 to ETRS89-EST [EST97] (1)','The coordinate epoch (in years) of the coordinates referenced to the source CRS (ITRF2014) is user-defined and is used as the source epoch in step 2.','EPSG','7789','EPSG','4934',0.005,'NKG2020',0);
INSERT INTO "usage" VALUES('EPSG','24003','concatenated_operation','EPSG','10825','EPSG','1090','EPSG','1027');
INSERT INTO "concatenated_operation" VALUES('EPSG','10868','ITRF2020 to ETRS89-EST [EST97] (1)','The coordinate epoch (in years) of the coordinates referenced to the source CRS (ITRF2020) is user-defined and is used as the source epoch in step 2.','EPSG','9988','EPSG','4934',0.005,'NKG2020',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','10871','ITRF2020 to ETRS89-LTU [LKS94] (1)','The coordinate epoch of the coordinates referenced to the source CRS (ITRF2020) is user-defined input and is used as the source epoch in step 2.','EPSG','9988','EPSG','4950',0.013,'NKG2020',0);
INSERT INTO "usage" VALUES('EPSG','24013','concatenated_operation','EPSG','10871','EPSG','1145','EPSG','1027');
INSERT INTO "concatenated_operation" VALUES('EPSG','10872','ITRF2020 to ETRS89-SWE [SWEREF 99] (1)','The coordinate epoch (in years) of the coordinates referenced to the source CRS (ITRF2020) is user-defined and is used as the source epoch in step 2. For coordinates originating before 2021-02-07, the NKG2008 transformation should be used.','EPSG','9988','EPSG','4976',0.004,'NKG2020',0);
INSERT INTO "usage" VALUES('EPSG','24008','concatenated_operation','EPSG','10872','EPSG','1225','EPSG','1027');
INSERT INTO "concatenated_operation" VALUES('EPSG','10894','ITRF2014 to ETRS89-DNK (1)','The coordinate epoch (in years) of the coordinates referenced to the source CRS (ITRF2014) is user-defined input and is used as the source epoch in step 2.','EPSG','7789','EPSG','10890',0.006,'NKG2020',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','11194','ITRF2020 to ETRS89-HRV [HTRS96] (1)','','EPSG','9988','EPSG','4888',0.1,'IOGP-Hrv 1995',0);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','11310','ITRF2020 to ETRS89-CHE [CHTRF95] (1)','','EPSG','9988','EPSG','11222',0.1,'IOGP-Che 1995',1);
...
INSERT INTO "concatenated_operation" VALUES('EPSG','11505','ETRS89-AUT [2002] to GHA height (2)','This concatenated operation gives the same result as the Hoehen-Grid plus offset from ETRS89-AUT [2002] to GHA height. HoehenGrid-plus is implemented in BEV-Transformator using MGI (CRS 4312) as the interpolation CRS for the grid.','EPSG','11056','EPSG','5778',0.07,'BEV-Aut 2002',0);
INSERT INTO "usage" VALUES('EPSG','26577','concatenated_operation','EPSG','11505','EPSG','1037','EPSG','1133');
INSERT INTO "concatenated_operation" VALUES('EPSG','11523','SKTRF09 + Baltic 1957 height to SKTRF09 + EVRF2007 height (2)','Recommended method for transforming coordinates between Baltic 1957 height and EVRF2007 height and vice-versa in Slovakia. Compound transformation using two separate quasigeoid models (DVRM05 and DMQSK2014E).','EPSG','11312','EPSG','11314',0.05,'UGKK-Svk',0);
INSERT INTO "usage" VALUES('EPSG','27019','concatenated_operation','EPSG','11523','EPSG','1211','EPSG','1059');
INSERT INTO "concatenated_operation" VALUES('EPSG','11528','ETRS89-SVK [SKTRF09] to S-JTSK (5)','Recommended method of a transformation from ETRS89 to S-JTSK in Slovakia. For reverse transformation see S-JTSK to ETRS89-SVK [SKTRF09] (6) (code 11529). Both together replace S-JTSK to ETRS89 (4) (code 4827).','EPSG','11076','EPSG','4156',0.06,'UGKK-Sk JTSK03',0);
