...
INSERT INTO "geodetic_crs" VALUES('EPSG','4289','Amersfoort','Use of this geographic2D CRS (Amersfoort, code 4289) for spatial referencing is discouraged. Use projected CRS RD (code 28992) or geodetic CRS ETRS89-NLD [AGRS2010] (codes 11035-11037).','geographic 2D','EPSG','6422','EPSG','6289',NULL,0);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','6666','JGD2024','Replaces JGD2000 (CRS code 4946) with effect from 21st October 2011. On adoption of JGD2024 (vertical) with effect from 1st April 2025, the name of this geodetic CRS was changed from JGD2011 to JGD2024; there is no change of definition or of coordinate values.','geocentric','EPSG','6500','EPSG','1128',NULL,0);
INSERT INTO "usage" VALUES('EPSG','4885','geodetic_crs','EPSG','6666','EPSG','1129','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','6667','JGD2024','Replaces JGD2000 (CRS code 4947) with effect from 21st October 2011. On adoption of JGD2024 (vertical) with effect from 1st April 2025, the name of this geodetic CRS was changed from JGD2011 to JGD2024; there is no change of definition or of coordinate values.','geographic 3D','EPSG','6423','EPSG','1128',NULL,0);
INSERT INTO "usage" VALUES('EPSG','4886','geodetic_crs','EPSG','6667','EPSG','1129','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','6668','JGD2024','Replaces JGD2000 (CRS code 4612) with effect from 21st October 2011. On adoption of JGD2024 (vertical) with effect from 1st April 2025, the name of this geodetic CRS was changed from JGD2011 to JGD2024; there is no change of definition or of coordinate values.','geographic 2D','EPSG','6422','EPSG','1128',NULL,0);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','9148','SIRGAS-Chile 2013','Densification within Chile of SIRGAS-CON at epoch 2013.00. Replaces SIRGAS-Chile 2002 (CRS code 5360) due to significant tectonic deformation. Replaced by SIRGAS-Chile 2016 (CRS code 9153).','geographic 2D','EPSG','6422','EPSG','1252',NULL,0);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','9694','REDGEOMIN','REDGEOMIN coordinates are updated on a biannual basis identified using syntax "REDGEOMIN([frame]@[epoch]", e.g. REDGEOMIN(IGS20@2024.0), REDGEOMIN(IGS20@2024.5), etc. This EPSG record references any of these updates without distinction. Users should include the update used in the metadata of  their spatial data metadata. Data should be reduced to this epoch using the ADELA deformation model.','geocentric','EPSG','6500','EPSG','1304',NULL,0);
INSERT INTO "usage" VALUES('EPSG','14939','geodetic_crs','EPSG','9694','EPSG','1066','EPSG','1188');
INSERT INTO "geodetic_crs" VALUES('EPSG','9695','REDGEOMIN','REDGEOMIN coordinates are updated on a biannual basis identified using syntax "REDGEOMIN([frame]@[epoch]", e.g. REDGEOMIN(IGS20@2024.0), REDGEOMIN(IGS20@2024.5), etc. This EPSG record references any of these updates without distinction. Users should include the update used in the metadata of  their spatial data metadata. Data should be reduced to this epoch using the ADELA deformation model.','geographic 3D','EPSG','6423','EPSG','1304',NULL,0);
INSERT INTO "usage" VALUES('EPSG','14947','geodetic_crs','EPSG','9695','EPSG','1066','EPSG','1188');
INSERT INTO "geodetic_crs" VALUES('EPSG','9696','REDGEOMIN','REDGEOMIN coordinates are updated on a biannual basis identified using syntax "REDGEOMIN([frame]@[epoch]", e.g. REDGEOMIN(IGS20@2024.0), REDGEOMIN(IGS20@2024.5), etc. This EPSG record references any of these updates without distinction. Users should include the update used in the metadata of  their spatial data metadata. Data should be reduced to this epoch using the ADELA deformation model.','geographic 2D','EPSG','6422','EPSG','1304',NULL,0);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','9988','ITRF2020','Replaces ITRF2014 (CRS code 7789). Updated through ITRF2020-u2023 from December 2024 and through ITRF2020-u2024 from October 2025. Users referencing updates should include this information in their metadata.','geocentric','EPSG','6500','EPSG','1322',NULL,0);
INSERT INTO "usage" VALUES('EPSG','17904','geodetic_crs','EPSG','9988','EPSG','1262','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','9989','ITRF2020','Replaces ITRF2014 (code 7912). Updated through ITRF2020-u2023 from December 2024 and through ITRF2020-u2024 from October 2025. Users referencing updates should include this information in their metadata.','geographic 3D','EPSG','6423','EPSG','1322',NULL,0);
INSERT INTO "usage" VALUES('EPSG','17902','geodetic_crs','EPSG','9989','EPSG','1262','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','9990','ITRF2020','Replaces ITRF2014 (code 9000). Updated through ITRF2020-u2023 from December 2024 and through ITRF2020-u2024 from October 2025. Users referencing updates should include this information in their metadata.','geographic 2D','EPSG','6422','EPSG','1322',NULL,0);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','10176','IGS20','For most practical purposes IGS20 is equivalent to ITRF2020. Replaces IGb14 (code 9378). Used for products from the International GNSS Service (IGS) from 2022-11-27: IGS20 used from 2022-11-27 to 2025-02-01 (GPS weeks 2238 through 2351); IGb20 (extract from ITRF2020-u2023) used from 2025-02-02 to 2026-01-10 (GPS weeks 2352 through 2400); IGc20 used from 2026-01-11 (GPS week 2401). Users referencing updates should include this information in their metadata.','geocentric','EPSG','6500','EPSG','1333',NULL,0);
INSERT INTO "usage" VALUES('EPSG','18627','geodetic_crs','EPSG','10176','EPSG','1262','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10177','IGS20','For most practical purposes IGS20 is equivalent to ITRF2020. Replaces IGb14 (code 9379). Used for products from the International GNSS Service (IGS) from 2022-11-27: IGS20 used from 2022-11-27 to 2025-02-01 (GPS weeks 2238 through 2351); IGb20 (extract from ITRF2020-u2023) used from 2025-02-02 to 2026-01-10 (GPS weeks 2352 through 2400); IGc20 used from 2026-01-11 (GPS week 2401). Users referencing updates should include this information in their metadata.','geographic 3D','EPSG','6423','EPSG','1333',NULL,0);
INSERT INTO "usage" VALUES('EPSG','18628','geodetic_crs','EPSG','10177','EPSG','1262','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10178','IGS20','For most practical purposes IGS20 is equivalent to ITRF2020. Replaces IGb14 (code 9380). Used for products from the International GNSS Service (IGS) from 2022-11-27: IGS20 used from 2022-11-27 to 2025-02-01 (GPS weeks 2238 through 2351); IGb20 (extract from ITRF2020-u2023) used from 2025-02-02 to 2026-01-10 (GPS weeks 2352 through 2400); IGc20 used from 2026-01-11 (GPS week 2401). Users referencing updates should include this information in their metadata.','geographic 2D','EPSG','6422','EPSG','1333',NULL,0);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','10779','ITRF2020-u2023','Replaces ITRF2020 (CRS code 9988).','geocentric','EPSG','6500','EPSG','1399',NULL,1);
INSERT INTO "usage" VALUES('EPSG','22372','geodetic_crs','EPSG','10779','EPSG','2830','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10780','ITRF2020-u2023','Replaces ITRF2020 (code 9989).','geographic 3D','EPSG','6423','EPSG','1399',NULL,1);
INSERT INTO "usage" VALUES('EPSG','22335','geodetic_crs','EPSG','10780','EPSG','1262','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10781','ITRF2020-u2023','Replaces ITRF2020 (code 9990).','geographic 2D','EPSG','6422','EPSG','1399',NULL,1);
INSERT INTO "usage" VALUES('EPSG','22336','geodetic_crs','EPSG','10781','EPSG','1262','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10783','IGb20','Used for products from the International GNSS Service (IGS) from 2025-02-02. Replaces IGS20 (code 10176). For most practical purposes IGb20 is equivalent to ITRF2020-u2023.','geocentric','EPSG','6500','EPSG','1400',NULL,1);
INSERT INTO "usage" VALUES('EPSG','22363','geodetic_crs','EPSG','10783','EPSG','2830','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10784','IGb20','Used for products from the International GNSS Service (IGS) from 2025-02-02. Replaces IGS20 (code 10177). For most practical purposes IGb20 is equivalent to ITRF2020-u2023.','geographic 3D','EPSG','6423','EPSG','1400',NULL,1);
INSERT INTO "usage" VALUES('EPSG','22364','geodetic_crs','EPSG','10784','EPSG','1262','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10785','IGb20','Used for products from the International GNSS Service (IGS) from 2025-02-02. Replaces IGS20 (code 10178). For most practical purposes IGb20 is equivalent to ITRF2020-u2023.','geographic 2D','EPSG','6422','EPSG','1400',NULL,1);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','10966','NATRF2022e2020','','geocentric','EPSG','6500','EPSG','1422',NULL,0);
INSERT INTO "usage" VALUES('EPSG','23623','geodetic_crs','EPSG','10966','EPSG','4803','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10967','NATRF2022e2020','','geographic 3D','EPSG','6423','EPSG','1422',NULL,0);
INSERT INTO "usage" VALUES('EPSG','23624','geodetic_crs','EPSG','10967','EPSG','4803','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','10968','NATRF2022e2020','','geographic 2D','EPSG','6422','EPSG','1422',NULL,0);
...
INSERT INTO "geodetic_crs" VALUES('EPSG','11471','SIRGAS-Chile 2025','Densification of SIRGAS-CON within Chile at epoch 2025.00. Replaces SIRGAS-Chile 2021 (CRS code 20039) due to significant tectonic deformation.','geocentric','EPSG','6500','EPSG','1462',NULL,0);
INSERT INTO "usage" VALUES('EPSG','26298','geodetic_crs','EPSG','11471','EPSG','1066','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','11472','SIRGAS-Chile 2025','Densification of SIRGAS-CON within Chile at epoch 2025.00. Replaces SIRGAS-Chile 2021 (CRS code 20040) due to significant tectonic deformation.','geographic 3D','EPSG','6423','EPSG','1462',NULL,0);
INSERT INTO "usage" VALUES('EPSG','26297','geodetic_crs','EPSG','11472','EPSG','1066','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','11473','SIRGAS-Chile 2025','Densification within Chile of SIRGAS-CON at epoch 2025.00. Replaces SIRGAS-Chile 2021 (CRS code 20041) due to significant tectonic deformation.','geographic 2D','EPSG','6422','EPSG','1462',NULL,0);
INSERT INTO "usage" VALUES('EPSG','26296','geodetic_crs','EPSG','11473','EPSG','1066','EPSG','1183');
...
INSERT INTO "geodetic_crs" VALUES('EPSG','20039','SIRGAS-Chile 2021','Densification of SIRGAS-CON within Chile at epoch 2021.00. Replaces SIRGAS-Chile 2016 (CRS code 9151) and replaced by SIRGAS-Chile 2025 (CRS code 11471) due to significant tectonic deformation.','geocentric','EPSG','6500','EPSG','1327',NULL,0);
INSERT INTO "usage" VALUES('EPSG','18454','geodetic_crs','EPSG','20039','EPSG','1066','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','20040','SIRGAS-Chile 2021','Densification of SIRGAS-CON within Chile at epoch 2021.00. Replaces SIRGAS-Chile 2016 (CRS code 9152) and replaced by SIRGAS-Chile 2025 (CRS code 11472) due to significant tectonic deformation.','geographic 3D','EPSG','6423','EPSG','1327',NULL,0);
INSERT INTO "usage" VALUES('EPSG','18455','geodetic_crs','EPSG','20040','EPSG','1066','EPSG','1027');
INSERT INTO "geodetic_crs" VALUES('EPSG','20041','SIRGAS-Chile 2021','Densification within Chile of SIRGAS-CON at epoch 2021.00. Replaces SIRGAS-Chile 2016 (CRS code 9153) and replaced by SIRGAS-Chile 2025 (CRS code 11473) due to significant tectonic deformation.','geographic 2D','EPSG','6422','EPSG','1327',NULL,0);
