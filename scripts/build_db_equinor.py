...
sql_dir_name = os.path.join(os.path.dirname(script_dir_name), 'data', 'sql_equinor')
...
for line in proj_db_conn.iterdump():
    if line.startswith('INSERT INTO "'):
        ...
        if table_name in files:
            ...
            f.write("--- This file has been generated by scripts/build_db_equinor.py. DO NOT EDIT !\n\n".encode('UTF-8'))
            files[table_name] = f
        f.write((line + '\n').encode('UTF-8'))
