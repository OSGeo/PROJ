...
projecting a point on the sphere to a face of the cube. This step is followed by a 
non-linear transformation to normalize the area of rectangles on the sphere. There are three
different choices available for this transformation, meaning that S2 is a family of projections.
...
for an explanation of the tradeoff between speed and area-preservation. See S2's `Earthcube page<https://s2geometry.io/resources/earthcube>`_
...
+-------------------------+-----------------------------+
|    ``+UVtoST=none``     | returns UV coordinates      |
+-------------------------+-----------------------------+
